...
public class MainActivity extends FragmentActivity {
    ...
    private Class mFragmentArray[] = {HomeFragment.class, ClassificationFragment.class,
            AddRequirementsFragment.class, MessageFragment.class, MyFragment.class};
    private  int mImageViewArray[] = {R.drawable.tab_menu_home,R.drawable.tab_menu_classification,
            R.drawable.tab_menu_add,R.drawable.tab_menu_message,R.drawable.tab_menu_my};
    private String mTextViewArray[] = {"首页","分类","添加","消息","我的"};
