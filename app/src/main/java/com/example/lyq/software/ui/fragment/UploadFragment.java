...
public class UploadFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_my_upload, container, false);
        initView();
        initData();
        return view;
    }
    ...
    private void initView() {
        ...
        adapter = new ReleaseAdapter(releaseList,imageList,userList,state,getActivity());
    ...
    private void parseJsonToEntity(String responseData) throws Exception{
        //=======注释:list不能写成list = null,这样将改变地址指向======
        releaseList.clear();
        imageList.clear();
        userList.clear();
        ...
        for (int i = 0; i < arrayRelease.length(); i++) {
            ...
            if (release != null){
                ...
                Log.e(Constants.TAG, "parseJsonToEntity: " + releaseList);
            }
        }
